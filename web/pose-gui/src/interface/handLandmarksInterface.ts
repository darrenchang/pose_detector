...
export interface handGestureInterface {
  [key: string]: string
}
...
const exampleHandGesture: handGestureInterface = {
  "left": "",
  "right": "",
}
...
export const handGestures: handGestureInterface = structuredClone(exampleHandGesture)
